...
export class EngineConstruct extends Construct {
	...
	constructor(scope: Construct, id: string, props: EngineConstructProperties) {
		...
		engineProcessorJobDefinition.container.executionRole.addManagedPolicy(ManagedPolicy.fromManagedPolicyArn(this, 'AmazonECSTaskExecutionRolePolicy', 'arn:aws:iam::aws:policy/service-role/AmazonECSTaskExecutionRolePolicy'))
		...
		NagSuppressions.addResourceSuppressions(engineProcessorJobDefinition.container, [
			{
		...
		NagSuppressions.addResourceSuppressions(engineProcessorJobDefinition.container.executionRole, [
			{
