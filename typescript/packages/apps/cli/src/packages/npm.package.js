...
var NpmPackage = /** @class */ (function (_super) {
    ...
    function NpmPackage() {
        ...
        _this.installTasks = _this.commands.map(function (c) {
            return {
                title: c.title,
                task: function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, (0, shell_js_1.execAsync)(c.command, { silent: isSilent })];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
    ...
    NpmPackage.prototype.getLinuxTasks = function () {
        return this.installTasks;
    };
    NpmPackage.prototype.getMacTasks = function () {
        return this.installTasks;
    };
    NpmPackage.prototype.getWindowsTasks = function () {
        return this.installTasks;
    };
    return NpmPackage;
